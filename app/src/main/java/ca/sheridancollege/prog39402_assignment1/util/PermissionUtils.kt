...
package ca.sheridancollege.prog39402_assignment1.util
...
object PermissionUtils {
     ...
     */
    fun requestPermission(activity: MapFragment, requestId: Int, permission: String, finishActivity: Boolean) {
        if (ActivityCompat.shouldShowRequestPermissionRationale(activity.activity!!, permission)) {
            // Display a dialog with rationale.
            RationaleDialog.newInstance(requestId, finishActivity).show(activity.activity!!.supportFragmentManager, "dialog")
        } else {
            // Location permission has not been granted yet, request it.
            ActivityCompat.requestPermissions(activity.activity!!, arrayOf(permission), requestId)
        }
    }
